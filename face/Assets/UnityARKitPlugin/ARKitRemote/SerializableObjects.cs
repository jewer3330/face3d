...
namespace UnityEngine.XR.iOS.Utils
{
	...
	public class serializableUnityARFaceAnchor
	{
		...
		public serializableUnityARMatrix4x4 leftEyeTransform;
		public serializableUnityARMatrix4x4 rightEyeTransform;
		...
		public static implicit operator serializableUnityARFaceAnchor(ARFaceAnchor rValue)
		{
			...
			return new serializableUnityARFaceAnchor(wt, sfg, rValue.blendShapes, idstr, rValue.isTracked,
				Matrix4x4.TRS(rValue.leftEyePose.position, rValue.leftEyePose.rotation, Vector3.one),
				Matrix4x4.TRS(rValue.rightEyePose.position, rValue.rightEyePose.rotation, Vector3.one));
		}
		#endif
	};
