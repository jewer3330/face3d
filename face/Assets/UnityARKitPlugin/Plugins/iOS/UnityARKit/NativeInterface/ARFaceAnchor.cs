...
namespace UnityEngine.XR.iOS
{
	...
	public struct UnityARFaceAnchorData
	{
		...
		public extern static UnityARFaceAnchorData GetUnityARFaceAnchorData(IntPtr ptrAnchors, uint index);
	}
	...
	public class ARFaceGeometry
	{
		...
		public ARFaceGeometry (UnityARFaceGeometry ufg)
		{
			...
			MarshalVertices(uFaceGeometry.vertices);
			MarshalTexCoords(uFaceGeometry.textureCoordinates);
			MarshalIndices(uFaceGeometry.triangleIndices);
		}
		...
		public Vector2 [] textureCoordinates { get { return m_TextureCoordinates; } }
	...
	public class ARFaceAnchor
	{
		...
		private Dictionary<string, float> m_blendshapesDictionary;
		...
		public UnityARMatrix4x4 leftEyeTransform
		{
			get { return (UnityARMatrix4x4) faceAnchorData.leftEyeTransform; }
		}
		public UnityARMatrix4x4 rightEyeTransform
		{
			get { return (UnityARMatrix4x4) faceAnchorData.rightEyeTransform; }
		}
		...
		public Dictionary<string, float> blendShapes { get { return blendshapesDictionary; } }
