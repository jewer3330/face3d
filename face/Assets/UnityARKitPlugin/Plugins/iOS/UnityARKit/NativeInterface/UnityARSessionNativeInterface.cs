...
namespace UnityEngine.XR.iOS
{
    ...
    public struct UnityARCamera
    {
        ...
        public ARFaceAnchor[] faceAnchors;
		...
		public UnityARCamera(UnityARMatrix4x4 wt, UnityARMatrix4x4 pm, ARTrackingState ats, ARTrackingStateReason atsr, UnityVideoParams uvp, UnityARLightData lightDat, UnityARMatrix4x4 dt, ARPointCloud ptCloud, ARWorldMappingStatus awms)
        {
            ...
            faceAnchors = new ARFaceAnchor[0];
        }
    }
...
#pragma warning restore CS0414
    ...
    public partial class UnityARSessionNativeInterface
    {
        ...
        // Face Landmark
        public delegate void LandmarkUpdate(Dictionary<string, Vector2> landmarks);
        public static event LandmarkUpdate EditorLandmarkUpdateEvent;

        private static UnityARCamera s_Camera;
        private static Dictionary<string, Vector2> s_Landmarks;
        ...
        public static void SetStaticLandmark(Dictionary<string, Vector2> landmarks)
        {
            s_Landmarks = landmarks;
        }
        public static void RunEditorLandmarkUpdateCallbacks()
        {
            if (EditorLandmarkUpdateEvent != null)
            {
                EditorLandmarkUpdateEvent(s_Landmarks);
            }
        }
        ...
        public static bool IsARKitRemoteServer()
        {
            return SceneManagement.SceneManager.GetActiveScene().name == "UnityARKitRemote";
        }
    }
}
